                            ...
                            <div class="content">
                                <table>
                                    <tr>
                                        <td>
                                            <h3>Dear '.$all.'</h3>
                                            <p class="lead">In our best efforts to provide an excellent service to all users of EXIT-TB DMS, we are currently performing system upgrade which will be completed on 09-06-2019. During the upgrade, some of functionality may not be available or not working properly.</p>
                                           
                                            <!-- Callout Panel -->
                                            <p class="callout">
                                                Once the upgrade is completed, you will be able to upload a complete CRF instead of uploading per pages
                                            </p><!-- /Callout Panel -->
                                            <p class="lead">Please report any issues to the central data management team. 
                                             +++++</p>
                                            <p class="lead">&nbsp;</p>
