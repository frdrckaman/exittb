...
class Email {
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            ...
                                            <!-- Callout Panel -->
                                            <p class="callout">
                                                Click the link to reset password <a href="'.$link.'">&nbsp;Reset Password &raquo;</a>
                                            </p><!-- /Callout Panel -->
    ...
    function systemMail($email,$subject){
                            ...
                            <div class="content">
                                <table>
                                    <tr>
                                        <td>
                                            <h3>Dear '.$all.'</h3>
                                            <p class="lead">In our best efforts to provide an excellent service to all users of EXIT-TB DMS, we are currently performing system upgrade which will be completed on 29-04-2019. During the upgrade, system operations will not be available.</p>
                                           
                                            <!-- Callout Panel -->
                                            <p class="callout">
                                                Once the upgrade is completed, you may notice an increase in system performance, speed and response time. Also, system will start to produce weekly reports.
                                            </p><!-- /Callout Panel -->
                                            <p class="lead">Please report any issues to the central data management team. We apologize for late notification and any inconvenience this may cause and we promise to do our best to complete this task perfectly in the shortest time possible. </p>
                                            <p class="lead">&nbsp;</p>
