...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
            ...
            <?php }
            elseif ($_GET['id'] == 22){?>
                <?php /* you should check for version in order to avoid file over write */?>
                <div class="block">
                    <div class="header">
                        <h2>DATA FILE</h2>
                    </div>
                    ...
                    <div class="content">
                        <table cellpadding="0" cellspacing="0" width="100%" class="table table-bordered table-striped sortable">
                            ...
                            <tbody>
                            <?php $x=1;foreach($override->getData('exit_data') as $data){?>
                                <tr>
                                    <td><?=$x?></td>
                                    <td><?=$data['name']?></td>
                                    <td><div class="btn-group btn-group-xs"><a href="download.php?file=<?=$data['attachment']?>" class="btn btn-success btn-clean"><span class="icon-download"></span> Click to Download</a></div></td>
                                </tr>
                                <?php $x++;}?>
                            </tbody>
                        </table>
