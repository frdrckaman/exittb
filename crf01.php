...
if($user->isLoggedIn()){
    ...
    if(Input::exists('post')){
        if(Input::get('crf01_pg1')){
            ...
            if ($validate->passed()) {
                try {
                    $user->updateRecord('crf01_pg01', array(
                        'country' => Input::get('country'),
                        'institution' => Input::get('institution'),
                        'facility' => Input::get('facility'),
                        'tbenum' => Input::get('tbenum'),
                        'study_id' => Input::get('study_id'),
                        'hospnum' => Input::get('hospnum'),
                        'vdate' => date('dmY',strtotime(Input::get('vdate'))),
                    ...
                    $query = $override->lastRow1('data_qry','status',0,'id');
                                ...
                                <div class="form-row" id="s1">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="vdate" class="datepicker form-control" value="<?=$data[0]['vdate']?>"/>
                                        </div>
                                    </div>
                                </div>
                                <h6>&nbsp;</h6>
